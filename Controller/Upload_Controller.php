...
if(isset($_POST['Upload_StuPreIntern_form']))
{
    ...
    if((isset($Other_Skill_list)) || (isset($OSSkill_set_arr)) || (isset($CMSSkill_set_arr)) || (isset($TechSkill_set_arr))){
      ...
      $Personalinfo_sql_qry = $Personalinfo_sql_qry." `Student_Country` = '".$_POST['Student_Country']."'";
    ...
    //----------------------------- Work Exp Data Structure -------------------------------------//
      ...
      if($Wrkexp1_till_date !== 'NULL' && $Wrkexp1_from_date !== 'NULL')
      {
        $d1 = new DateTime($Wrkexp1_from_date);
        $d2 = new DateTime($Wrkexp1_till_date);
    	...
    	$Wrkexp_sql_qry = $Wrkexp_sql_qry." `WrkExp1_Duration` = '".$months."',";
      ...
      if($Wrkexp2_till_date !== 'NULL' && $Wrkexp2_from_date !== 'NULL')
      {
        $d1 = new DateTime($Wrkexp2_from_date);
        $d2 = new DateTime($Wrkexp2_till_date);
    	...
    	$Wrkexp_sql_qry = $Wrkexp_sql_qry." `WrkExp2_Duration` = '".$months."',";
      ...
      if($Wrkexp3_till_date !== 'NULL' && $Wrkexp3_from_date !== 'NULL')
      {
        $d1 = new DateTime($Wrkexp3_from_date);
        $d2 = new DateTime($Wrkexp3_till_date);
      ...
      $Wrkexp_sql_qry = $Wrkexp_sql_qry." `WrkExp3_Duration` = '".$months."',";
      ...
      if($Wrkexp4_till_date !== 'NULL' && $Wrkexp4_from_date !== 'NULL')
      {
        $d1 = new DateTime($Wrkexp4_from_date);
        $d2 = new DateTime($Wrkexp4_till_date);
      ...
      $Wrkexp_sql_qry = $Wrkexp_sql_qry." `WrkExp4_Duration` = '".$months."'";
    ...
    if($Student_chk_from_Stu_details !== 0)
    {
        ...
        $Personalinfo_sql_qry = $Personalinfo_sql_qry." ,`Updated_date` = '".date('Y-m-d')."'";
        ...
        if($ProfileType == "Student"){
          ...
          $Student_recourd_chk = Check_Student_id_StuDetails($StudentID);

          if($Student_recourd_chk)
          {
            $StuPreIntern_Details = $Upload_StuPreIntern_Details_obj->retrieveStudent_PreIntern_details($StudentID);

            include("../View/Upload_form_student.php");
          }
        }
        else {
          # code...

          if(isset($_POST['Student_id_update']))
          {
            header('Location: ../Controller/View_Controller.php');
          }
          else {
            # code...
      ...
      if($ProfileType == "Student"){
        ...
        if($Student_recourd_chk)
        {
          ...
          include("../View/Upload_form_student.php?info=updated");
        }
      }
      else {
        # code...
