			...
			<div class="row-fluid" >
              ...
              <? if($ProfileType == "Admin") { ?>
  			  ...
  			  <div class="row-fluid sortable">
                  ...
                  <span class="col-md-6" style="margin-left: 4em;"> </span>
                      ...
                      <div class="panel-body">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <div class="input">
                              ...
                              <? if($ProfileType == "Student"){ ?>
                              <input id="Student_fname_disabled" name="Student_fname_disabled" size="16" type="text" value=<?echo $User_fname;?> disabled/>
                              <input id="Student_fname" name="Student_fname" size="16" type="text" value=<?echo $User_fname;?> style="display:none"/>
                              <? }
                              else
                              {  ?>
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <div class="input">
                              <? if($ProfileType == "Student"){ ?>
                              <input id="Student_lname_disabled" name="Student_lname_disabled" size="16" type="text" value=<?echo $User_lname;?> disabled/>
                              <input id="Student_lname" name="Student_lname" size="16" type="text" value=<?echo $User_lname;?> style="display:none"/>
                              <? }
                              else
                              {  ?>
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <div class="input">
                              <? if($ProfileType == "Student"){ ?>
                              <input id="Student_email_disabled" name="Student_email_disabled" size="16" type="text" value=<?echo $Useremail;?> disabled/>
                              <input id="Student_email" name="Student_email" size="16" type="text" value=<?echo $Useremail;?> style="display:none"/>
                              <? }
                              else
                              {  ?>
